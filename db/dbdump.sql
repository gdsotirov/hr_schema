...
CREATE TABLE `person_relation_types` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_prel_type_rev` (`reverse_id`) /*!80000 INVISIBLE */,
  CONSTRAINT `fk_prel_type_rev` FOREIGN KEY (`reverse_id`) REFERENCES `person_relation_types` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-18 20:40:31
